...
fileListShort{1} = 'Simulated_data_EtEv0-38_k185';
...
%% PERC-specific
clear all; close all; 
dirname = 'C:\Users\Mallory\Dropbox (MIT)\Mallory in Australia\Method development\SRH test\modifying_raw\PERC\unaltered\Excel';
load([dirname '\meas_info.mat']); 
load([dirname '\Raw_data.mat']); 
saveName = 'C:\Users\Mallory\Dropbox (MIT)\Mallory in Australia\Method development\SRH test\modifying_raw\PERC';
W = info(2).thickness; 
